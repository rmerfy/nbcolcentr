...
<?php get_header(); ?>
<section class="opening-main skin-page">
...
<section class="aboutservice wrapper">
	...
	<div class="aboutservice-aside">
		...
		<div class="aboutservice-aside__price-wrapper">
			<div class="aboutservice-aside__price">
				<div class="aboutservice-aside__price-item animated right">
					<?php the_field('s2_zashhita_kozhi') ?>
				</div>
				<div class="aboutservice-aside__price-item animated right">
					<?php the_field('s2_zashhita_tekstilya') ?>
				</div>
...
<section class="topresult wrapper">
	...
	<div class="result-slider animated bot">
		<?php
				if ( have_rows('s3_slajder') ) { // если найдены данные 
					while ( have_rows('s3_slajder') ) { the_row(); // цикл по строкам данных 
						?>
		<div class="result-slider-item">
			<div class="prev-block">
				<p class="nav-title">
					<?php the_sub_field('s3_slajder_predydushhij_zagolovok') ?>
				</p>
				<img src="<?php the_sub_field('s3_slajder_predydushhee_izobrazhenie') ?>" class="img">
			</div>
			<div class="center-block">
				<div class="result-slider-thumb">
					<?php
										if ( have_rows('s3_slajder_vnutri_slajdera') ) { // если найдены данные 
											while ( have_rows('s3_slajder_vnutri_slajdera') ) { the_row(); // цикл по строкам данных 
												?>
					<div class="result-slider-thumb__item">
						<img src="<?php the_sub_field('s3_kartinka_slajdera_vnutri_slajdera') ?>" class="img">
					</div>
					<?php
											}
										} else {
				...
				<div class="center-block__info">
					<div class="center-block__text">
						<p class="center-block__title">
							<?php the_sub_field('s3_czentralnyj_zagolovok_slajdera') ?>
						</p>
						<ul>
							<?php
											if ( have_rows('s3_spisok_v_slajdere') ) { // если найдены данные 
												while ( have_rows('s3_spisok_v_slajdere') ) { the_row(); // цикл по строкам данных 
													?>
							<li><?php the_sub_field('s3_tekst_spiska_v_slajdere') ?></li>
							<?php
												}
											} else {
												// строки не найдены 
			...
			<div class="next-block">
				<p class="nav-title">
					<?php the_sub_field('s3_sleduyushhij_zagolovok') ?>
				</p>
				<img src="<?php the_sub_field('s3_sleduyushhee_izobrazhenie') ?>" class="img">
			</div>
		</div>
		<?php
					}
		...
		<div class="about-main-wrapper">
			<div class="about-main-info">
				<div class="about-main__text animated left">
					...
					<p>
						<?php the_field('s4_tekst') ?>
					</p>
					<p>
						<?php the_field('s4_tekst_2') ?>
					</p>
				</div>
				<!-- <div class="about-main__vid animated left">
						<p class="about-main__vid-title">
							<?php the_field('s4_video_tekst') ?>
						</p>
						...
						<div class="about-main__vid-preview popup__toggle-2">
							<img src="<?php the_field('s4_kartinka_video') ?>" alt="" class="img">
						</div>
					</div> -->
				<div class="bullets-withplus">
					<div class="bullets-withplus__item animated bot">
						...
						<p class="bullets-withplus__title">
							<?php the_field('s4_blok_1_zagolovok') ?>
						</p>
						<p class="bullets-withplus__text">
							<?php the_field('s4_blok_1_podzagolovok') ?>
						</p>
					</div>
					<div class="bullets-withplus__item animated bot delay03">
						<span class="plus-icon"></span>
						<p class="bullets-withplus__title">
							<?php the_field('s4_blok_2_zagolovok') ?>
						</p>
						<p class="bullets-withplus__text">
							<?php the_field('s4_blok_2_podzagolovok') ?>
						</p>
					</div>
					<div class="bullets-withplus__item animated bot delay06">
						<span class="plus-icon"></span>
						<p class="bullets-withplus__title">
							<?php the_field('s4_blok_3_zagolovok') ?>
						</p>
						<p class="bullets-withplus__text">
							<?php the_field('s4_blok_3_podzagolovok') ?>
						</p>
					</div>
				</div>
			</div>
